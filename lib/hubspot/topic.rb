module OldHubspot
  ...
  class Topic
    ...
    class << self
      ...
      # @return [OldHubspot::Topic] array of topics
      def list
        response = OldHubspot::Connection.get_json(TOPICS_PATH, {})
      ...
      # @return OldHubspot::Topic
      def find_by_topic_id(id)
        response = OldHubspot::Connection.get_json(TOPIC_PATH, { topic_id: id })
        new(response)
      end
    end
