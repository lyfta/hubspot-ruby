  ...
  describe '.find' do
    ...
    context 'with an invalid ID' do
      ...
      it 'raises an error' do
        expect {
          subject
        }.to raise_error(OldHubspot::RequestError, /resource not found/)
      end
    end
  end
  ...
  describe '.add_contact' do
    ...
    context 'with a valid company ID and invalid contact ID' do
      ...
      it 'raises an error' do
        expect {
          subject
        }.to raise_error(OldHubspot::RequestError, /Contact with the vid/)
      end
    end
    ...
    context 'with an invalid company ID' do
      ...
      it 'raises an error' do
        expect {
          subject
        }.to raise_error(OldHubspot::RequestError, /company with the ID/)
      end
    end
  end
