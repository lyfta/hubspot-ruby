describe OldHubspot::Engagement do
  ...
  describe 'EngagementNote' do
    ...
    describe ".associate!" do
      ...
      let(:contact) { OldHubspot::Contact.create!("newcontact#{Time.now.to_i}@hsgem.com") }
      subject { OldHubspot::Engagement.associate!(engagement.id, 'contact', contact.vid) }

      it 'associate an engagement to a resource' do
        subject
        found_by_contact = OldHubspot::Engagement.find_by_contact(contact.vid)
