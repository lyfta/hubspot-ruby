describe OldHubspot::CompanyProperties do
  ...
  describe 'Properties' do
    describe '.all' do
      context 'with no filter' do
        ...
        it 'should return all properties' do
          expect(OldHubspot::CompanyProperties.all).to eql(example_properties)
        end
      end
      ...
      context 'with included groups' do
        ...
        it 'should return properties for the specified group[s]' do
          response = OldHubspot::CompanyProperties.all({}, { include: groups })
      ...
      context 'with excluded groups' do
        ...
        it 'should return properties for the non-specified group[s]' do
          response = OldHubspot::CompanyProperties.all({}, { exclude: groups })
    ...
    let(:valid_params) { params.select { |k, _| OldHubspot::CompanyProperties::PROPERTY_SPECS[:field_names].include?(k) } }
    ...
    describe '.create!' do
      context 'with no valid parameters' do
        ...
        it 'should return nil' do
          expect(OldHubspot::CompanyProperties.create!({})).to be(nil)
        end
      end
      ...
      context 'with all valid parameters' do
        ...
        it 'should return the valid parameters' do
          response = OldHubspot::CompanyProperties.create!(params)
    ...
    describe '.update!' do
      context 'with no valid parameters' do
        ...
        it 'should return nil ' do
          expect(OldHubspot::CompanyProperties.update!(params['name'], {})).to be(nil)
        end
      end
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          response = OldHubspot::CompanyProperties.update!(params['name'], params)
          valid_params.each { |k, v| expect(response[k]).to eq(v) }
        end
      end
    end
    ...
    describe '.delete!' do
      ...
      context 'with existing property' do
        ...
        it 'should return nil' do
          expect(OldHubspot::CompanyProperties.delete!(name)).to eq(nil)
        end
      end
      ...
      context 'with non-existent property' do
        ...
        it 'should raise an error' do
          expect { OldHubspot::CompanyProperties.delete!(name) }.to raise_error(OldHubspot::RequestError)
        end
      end
    end
  end
    ...
    describe '.groups' do
      context 'with no filter' do
        ...
        it 'should return all groups' do
          expect(OldHubspot::CompanyProperties.groups).to eql(example_groups)
        end
      end
      ...
      context 'with included groups' do
        ...
        it 'should return the specified groups' do
          response = OldHubspot::CompanyProperties.groups({}, { include: groups })
      ...
      context 'with excluded groups' do
        ...
        it 'should return groups that were not excluded' do
          response = OldHubspot::CompanyProperties.groups({}, { exclude: groups })
    ...
    describe '.create_group!' do
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(OldHubspot::CompanyProperties.same?(response, params)).to be_true
        end
      end
      ...
      context 'with some valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(OldHubspot::CompanyProperties.same?(response, sub_params)).to be_true
        end
      end
    end
