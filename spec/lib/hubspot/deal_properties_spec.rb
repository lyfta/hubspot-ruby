  ...
  describe 'Properties' do
    describe '.all' do
      context 'with no filter' do
        ...
        it 'should return all properties' do
          expect(OldHubspot::DealProperties.all).to eql(example_properties)
        end
      end
    ...
    describe '.create!' do
      ...
      context 'with all valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(OldHubspot::DealProperties.same?(params, response)).to be_true
        end
      end
    end
    ...
    describe '.update!' do
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          response = OldHubspot::DealProperties.update!(params['name'], params)
          expect(OldHubspot::DealProperties.same?(response, params)).to be_true
        end
      end
    end
    ...
    describe '.delete!' do
      ...
      context 'with existing property' do
        ...
        it 'should return nil' do
          expect(OldHubspot::DealProperties.delete!(name)).to eq(nil)
        end
      end
      ...
      context 'with non-existent property' do
        ...
        it 'should raise an error' do
          expect { OldHubspot::DealProperties.delete!(name) }.to raise_error(OldHubspot::RequestError)
        end
      end
    end
  end
  ...
  describe 'Groups' do
    describe '.groups' do
      context 'with no filter' do
        ...
        it 'should return all groups' do
          expect(OldHubspot::DealProperties.groups).to eql(example_groups)
        end
      end
    ...
    describe '.create_group!' do
      ...
      context 'with some valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(OldHubspot::DealProperties.same?(response, sub_params)).to be_true
        end
      end
    end
    ...
    describe '.delete_group!' do
      ...
      context 'with non-existent group' do
        ...
        it 'should raise an error' do
          expect { OldHubspot::DealProperties.delete_group!(name) }.to raise_error(OldHubspot::RequestError)
        end
      end
    end
  end
